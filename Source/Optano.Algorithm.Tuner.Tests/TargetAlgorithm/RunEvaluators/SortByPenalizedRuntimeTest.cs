...
namespace Optano.Algorithm.Tuner.Tests.TargetAlgorithm.RunEvaluators
{
    ...
    /// <summary>
    /// Contains tests for the <see cref="SortByPenalizedRuntime{TInstance}"/> class.
    /// </summary>
    public class SortByPenalizedRuntimeTest
    {
        #region Static Fields

        /// <summary>
        /// The <see cref="SortByPenalizedRuntime{TInstance}"/> sorter used in tests.
        /// </summary>
        private static readonly SortByPenalizedRuntime<TestInstance> Sorter = new SortByPenalizedRuntime<TestInstance>(1, TimeSpan.FromSeconds(30));
        ...
        /// <summary>
        /// Checks that <see cref="SortByPenalizedRuntime{TInstance}.Sort"/>
        ...
        public void SortCanHandleDifferentNumberOfRunsPerGenome2()
        {
            ...
            var worseStats = this.CreateStats(worseGenome, SortByPenalizedRuntimeTest.Instances, i => TimeSpan.FromMilliseconds(100), 1);
            var betterStats = this.CreateStats(betterGenome, SortByPenalizedRuntimeTest.Instances, i => TimeSpan.FromMilliseconds(200));
        ...
        /// <summary>
        /// Checks that <see cref="SortByPenalizedRuntime{TInstance}.GetMetricRepresentation"/> returns the total number of seconds for a
        /// successful <see cref="RuntimeResult"/>.
        /// </summary>
        [Fact]
        public void GetMetricRepresentationReturnsSecondsForSuccessfulRun()
        {
            var parSorter = new SortByPenalizedRuntime<TestInstance>(factorPar: 7, TimeSpan.FromSeconds(3.1));
        ...
        /// <summary>
        /// Checks that <see cref="SortByPenalizedRuntime{TInstance}.GetMetricRepresentation"/> returns the total number of seconds
