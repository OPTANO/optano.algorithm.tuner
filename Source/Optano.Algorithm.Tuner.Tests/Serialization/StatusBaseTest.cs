        ...
        where T : StatusBase
    {
        ...
        public void WriteToFileThrowsForUnknownDirectory()
        {
            ...
            Assert.Throws<DirectoryNotFoundException>(
                () => status.WriteToFile(PathUtils.GetAbsolutePathFromExecutableFolderRelative($@"non{Path.DirectorySeparatorChar}existing{Path.DirectorySeparatorChar}path")));
        }
                ...
                watcher.Changed += (sender, e) =>
                    {
                        ...
                        {
                            // ToDo: This (old) line causes the the test to fail. I have no idea why.
                            // I also do not understand why the assert is made in the first place.
