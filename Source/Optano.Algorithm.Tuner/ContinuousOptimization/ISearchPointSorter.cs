...
namespace Optano.Algorithm.Tuner.ContinuousOptimization
{
    ...
    public interface ISearchPointSorter<TSearchPoint>
        where TSearchPoint : SearchPoint
    {
        ...
        IList<int> Sort(IList<TSearchPoint> points);
        ...
        Dictionary<TSearchPoint, int> DetermineRanks(IList<TSearchPoint> points);
