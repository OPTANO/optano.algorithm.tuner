...
namespace Optano.Algorithm.Tuner.GenomeEvaluation.MiniTournaments
{
    ...
    /// <summary>
    /// Responsible for evaluating all incumbent genomes with <see cref="MiniTournamentGenerationEvaluationStrategy{TInstance,TResult}"/>.
    /// </summary>
    /// <typeparam name="TInstance">The instance type.</typeparam>
    /// <typeparam name="TResult">The result type.</typeparam>
    public class MiniTournamentIncumbentEvaluator<TInstance, TResult>
