...
namespace Optano.Algorithm.Tuner.MachineLearning.RandomForest.RandomForestTopPerformerFocus
{
    ...
    /// <summary>
    /// Specific random forest that tries to predict the <see cref="ITargetAlgorithm{TInstance,TResult}"/>s performance, using a sprecific <see cref="Genome"/> as its configuration.
    ...
    /// </typeparam>
    public class GenomePredictionRandomForest<TSamplingStrategy> :
        ...
        where TSamplingStrategy : IEnsembleSamplingStrategy<IGenomePredictor>, new()
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GenomePredictionRandomForest{TSamplingStrategy}"/> class.
        /// </summary>
        /// <param name="config">
        ...
        /// </param>
        public GenomePredictionRandomForest(GenomePredictionRandomForestConfig config, int featuresPerSplit)
        {
        ...
        /// <summary>
        /// OPTANO Algorithm Tuner specific method to start the training of the <see cref="GenomePredictionRandomForest{TSamplingStrategy}"/>.
        /// </summary>
        /// <param name="data">
        ...
        {
            // aggregate + export aggregated data
        ...
        /// <summary>
        /// Method that makes the generically typed call to <see cref="GenericRandomizedForestBase{TForestModel,TTreeTypeModel}"/>, using the <see cref="TopPerformerFocusSplitCriterion"/> and <see cref="TopPerformerFocusImpurityCalculator"/>.
        /// </summary>
                ...
                this.CreateTree<
                    GenericRegressionDecisionTreeLearner<
                        DepthFirstTreeBuilder<
                            ...
                            TopPerformerFocusImpurityCalculator>,
                        GenomePredictionTree,
                        TopPerformerFocusSplitCriterion,
                        TopPerformerFocusImpurityCalculator>,
                    DepthFirstTreeBuilder<
